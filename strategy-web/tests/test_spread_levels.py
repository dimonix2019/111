...
def test_enter_short_cross_up_wide():
    ...
    # Cross 6.2 from below while landing in wide

    assert (

        determine_spread_level_signal(6.1, 6.2, Position.FLAT, lv)

        == Signal.ENTER_SHORT

    )

    # Already above — no re-cross
...
def test_transition_no_enter():
    ...
    # Transition zone: crossing 5.0 → 5.4 does nothing; enter needs 6.2.
