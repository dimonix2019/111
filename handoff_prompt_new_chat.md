...
## Backlog (именованные задачи)

| Кодовое имя | Файл | Статус |
|-------------|------|--------|
| **Переход на 10-и минутки** | `docs/perehod-na-10-minutki.md` | Отложено (новый месяц / лимиты Cursor) |
| Parity журнала vs «Тест страт.» | `MoexParityReplayTest`, `journal_vs_sim_parity.py` | **Активно сейчас** |

Чтобы возобновить отложенную задачу в чате: напиши **«Переход на 10-и минутки»**.

## Для агента

- Читай `handoff_prompt_new_chat.md` и блок PROMPT выше.
- Backlog с именами: `docs/perehod-na-10-minutki.md`.
