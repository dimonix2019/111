...
class MoexPortfolioClosedTradesSynthTest {
    ...
    @Test
    fun filterClosedSynthWhenStillOpen_keepsOpenAndDropsMatchingSynthClosed() {
        ...
        val synthClosed = buildClosedRowsFromSandboxOpensAndJournalExits(
        ...
        assertEquals(1, synthClosed.size)
        val filtered = filterClosedSynthWhenStillOpen(synthClosed, listOf(open))
