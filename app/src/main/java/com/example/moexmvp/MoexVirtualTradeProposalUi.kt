        ...
        Text(
            text = when (sandboxState) {
                ...
                SandboxExecUiState.MissingCredentials ->
                    "Исполнение на песочнице включено: сохраните токен и счёт на вкладке «Песочница»; переключатель «Исполнять вход на демо» — на «Портфеле»."
                SandboxExecUiState.Off ->
                    "Исполнение на песочнице выключено — только учёт в приложении (переключатель на вкладке «Портфель»)."
            },
