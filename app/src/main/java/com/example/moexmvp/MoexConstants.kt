...
2.0.51 — «Рынок»: обновление спреда больше не висит на полной неделе ISS. Опрос — только хвост за сегодня (8 с), первая загрузка ≤20 с. После зума шкалы график снова принимает свечи.
"""
