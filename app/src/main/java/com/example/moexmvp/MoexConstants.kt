...
2.0.37 — Long/Short: сначала шорт-нога (продажа), затем покупка; если вторая нога не прошла — откат первой. Запас до маржин-колла = ликвид − мин.маржа (как в Т‑Инвест), не ликвид − скорр.маржа.
