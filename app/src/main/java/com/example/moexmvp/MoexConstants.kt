...
1.6.62 — Сигналы/push: только на закрытом 15м баре (как в тестере), Z из кэша 255 дн.; фоновый монитор больше не считает Z за 1 день; 2 ноги демо — одно уведомление.
