...
2.0.34 — «Сделка»: экстренное закрытие шлёт рыночные заявки по лотам GetPortfolio (не только журнал); Long/Short всегда на боевой счёт, даже если режим «Песочница». TATN/TATNP в портфеле по figi/uid.
2.0.33 — Зум по правой шкале цены сужает диапазон оси (тики 4.0 / 4.1 / 4.2, не 4.0 / 4.5 / 5.0). Двойной тап по шкале сбрасывает. «Сделка»: история с GetOperations.
2.0.32 — Зум по правой шкале стал в 3 раза чувствительнее. «Сделка»: история чинится — операции Т‑Инвест не несут поля ticker, теперь тикеры распознаются по figi/instrumentUid (сделки снова грузятся со счёта).
2.0.31 — График: вертикальный зум пальцем по правой ценовой шкале (двойной тап — сброс). «Сделка»: история сделок за 2 недели теперь со счёта Т‑Инвест (GetOperations), без привязки к ПК.
2.0.30 — «Сделка»: кнопки «Открыть Long/Short» (пара на боевом счёте, лоты как у AUTO) и таблица закрытых сделок за 2 недели (из web-стола или локального журнала).
"""
