...
2.0.36 — «Сделка»: при открытии Long/Short задаётся take profit в % и в ₽ (по умолчанию 2% от вложения). Прогноз, линия на графике и автозакрытие пары используют этот порог.
