...
2.0.44 — «Сделка»: прогноз закрытия ближе к деньгам на счёте. Стакан T‑Invest (VWAP на лоты), иначе слип 0,14% а не ±0,05 ₽ (12.09 было −84 ₽ при факте −173 ₽). Строка «на счёте останется».
"""
